...
$result = $conn->query("SELECT * FROM agents LIMIT $offset, $recordsPerPage");
$totalRecords = $conn->query("SELECT COUNT(*) AS total FROM agents")->fetch_assoc()['total'];

// Handle delete operation
if (isset($_POST['delete_id'])) {
    $delete_id = $_POST['delete_id'];
    $conn->query("DELETE FROM agents WHERE id = $delete_id");
}
...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div style="background-color: #fff; border: 1px solid #ddd; padding: 200px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <form style="text-align: center;" method="post">

      <input type="text" id="inputField" name="cat_name" style="width: 100%; padding: 8px; box-sizing: border-box; margin-bottom: 10px;" required>
...
// Initialize variable to store input field value
$cat_name = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO countries (cat_name) VALUES ('$cat_name')";
