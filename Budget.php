                ...
                <li id="part2_li">
                   <?php
                    ...
                    while ($row_cats = mysqli_fetch_array($run_cats)) {
                        ...
                        echo "<ul><a class='$activeClass' href='Budget.php?cat=$cat_id'>$cat_name</a></ul><hr>";
                    }
                    ?>
                   </li>
               </div>
...
if ($selected_cat_id) {
    $get_details = "SELECT * FROM budget WHERE cat_id = '$selected_cat_id'";
} else {
    // Fetch all university details when no category is selected
    $get_details = "SELECT * FROM budget";
}
...
if ($run_details) {
    while ($row = mysqli_fetch_array($run_details)) {
        ?>
                <h1>Cost of living and studing in Uk</h1><br>
                <p><?php echo $row['intro']; ?></p>
                <h1>How much does it cost to study in the UK?</h1><br>
                <h2>cource fee</h2><br>
                <p><?php echo $row['courcefee']; ?></p><br>
                <h2>Undergraduate -</h2><br>
                <p><?php echo $row['bacholar']; ?></p><br>
                <h2>Postgraduate -</h2><br>
                <p><?php echo $row['masters']; ?></p><br>
                <h1>Visa</h1><br>
                <p><?php echo $row['visa']; ?></p><br>
                <h1>Language</h1><br>
                <p><?php echo $row['language']; ?></p><br>
                <h1>insurance</h1><br>
                <p><?php echo $row['insurance']; ?></p><br>
                <h1>accomdation</h1><br>
                <p><?php echo $row['accomodation']; ?></p><br>
                <h1>Tickets</h1><br>
                <p><?php echo $row['tickets']; ?></p><br>
                <table>
                    <tr>
                        <th>Budget</th>
                        <th>cost</th>
                    ...
                    <td><?php echo $row['value5']; ?></td>
                        <td><?php echo $row['price5']; ?></td>
                    </tr>
                    <tr>
                    <td><?php echo $row['value6']; ?></td>
                        <td><?php echo $row['price6']; ?></td>
                    </tr>
                    <tr>
                    <td><?php echo $row['value7']; ?></td>
                        <td><?php echo $row['price7']; ?></td>
                    </tr>
                </table><br><br><br>
